...
**Цель работы:** реализация моделей PropCare и DLCE, проведение экспериментов над этими моделями, формирование качественного и структурированного кода. Подробное описание моделей реализованных в данном коде и результаты эксперементов можно посмотреть в самой работе ([латех версия работы](https://ru.overleaf.com/project/686fe80513564e2a218ff4ed))
...
- Все зависимости перечислены в файле environment.yml. Для начала создайте окружение и скачайте туда основные зависимости:
  ...
  ```
  Затем активируйте окрдение и скачайте туда модуль написанный в этом проекте
   ```bash
